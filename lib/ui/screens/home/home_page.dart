  ...
  Widget build(BuildContext context) {
    ...
    return BlocListener<PostBloc, PostState>(
      ...
      child: Scaffold(
          ...
          appBar: AppBar(
            backgroundColor: Colors.white,
            title: const TextCustom(text: LanguageJameet.project_name, fontWeight: FontWeight.w600, fontSize: 22, color: ColorsJameet.secundary, isTitle: true,),
            elevation: 0,
            actions: [
              IconButton(
                  splashRadius: 20,
          ...
          bottomNavigationBar: const BottomNavigationJameet(index: 1)
      ),
    );
  }
}
                    ...
                    children: [
                      Row(
                        ...
                        children: [
                          ...
                          IconButton(
                              onPressed: (){
                                //debugPrint(posts.personUid);
                                //print(LanguageJameet.project_name);
                                Navigator.push(context, routeSlide(page: ProfileAnotherUserPage(idUser: posts.personUid)));
                              },
                                ...
                                children: [
                                  Row(
                                    children: [
                                      ...
                                      TextButton(
                                        ...
                                        child: Row(
                                          children: [
                                            SvgPicture.asset('assets/svg/message-icon.svg', height: 22),
                                  ...
                                  Row(
                                    children: [
                                       ...
                                       */
                                            Share.share( Environment.baseUrl+ listImages[0] , subject: posts.username );
                                          },
