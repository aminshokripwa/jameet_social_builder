      ...
      child: Row(
        children: [
          ...
          Column(
            ...
            children: const [
              TextCustom(text: LanguageJameet.this_account_is_private, fontWeight: FontWeight.w500),
              TextCustom(text: LanguageJameet.follow_to_see_its_photo, color: Colors.grey, fontSize: 16),
            ],
          )
        ],
      ),
    ...
    return Row(
      ...
      children: [
        Container(
          ...
          width: size.width * .5,
          decoration: BoxDecoration(
            color: isFriend == 1 || isPendingFollowers == 1 ? Colors.white : ColorsJameet.primary,
          ...
          ? TextButton(
              ...
              child: TextCustom(
                text: isFriend == 1 ? LanguageJameet.following : LanguageJameet.follow ,
                fontSize: 20, 
          ...
          : TextButton(
              ...
              child: const TextCustom(text: LanguageJameet.pending, fontSize: 20, color: Colors.black),
              onPressed: (){
        ...
        Container(
          ...
          child: TextButton(
            ...
            child: const TextCustom(text: LanguageJameet.message, fontSize: 20),
            onPressed: () 
              => Navigator.push(
                  context, 
              ...
              children: [
                Column(
                  children: [
                    ...
                    const TextCustom(text: LanguageJameet.post,  fontSize: 17, color: Colors.grey),
                  ],
                ),
                Column(
                  children: [
                    TextCustom(text: analytics.friends.toString(),  fontSize: 22, fontWeight: FontWeight.w500),
                    const TextCustom(text: LanguageJameet.following, fontSize: 17, color: Colors.grey),
                  ],
                ),
                Column(
                  children: [
                    TextCustom(text: analytics.followers.toString(),  fontSize: 22, fontWeight: FontWeight.w500),
                    const TextCustom(text: LanguageJameet.followers, fontSize: 17, color: Colors.grey),
                  ],
                ),
