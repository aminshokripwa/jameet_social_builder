...
class _SearchPageState extends State<SearchPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      bottomNavigationBar: const BottomNavigationJameet(index: 2),
    );
  }
    ...
    return StreamBuilder<List<UserFind>>(
      ...
      builder: (context, snapshot) {
        ...
        if( snapshot.data!.isEmpty ) {
          return ListTile(
            title: TextCustom(text: '${LanguageJameet.no_results_for} ${_searchController.text}'),
          );
        }
    ...
    return GridView.builder(
        ...
        itemBuilder: (context, i) {
          ...
          return GestureDetector(
            onTap: () => modalShowPost(context, post: posts[i]),
              child: Container(
