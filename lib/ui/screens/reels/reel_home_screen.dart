...
import 'package:jameet_social_builder/ui/screens/reels/widgets/modal_more_option.dart';
...
class ReelHomeScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      bottomNavigationBar: const BottomNavigationJameet(index: 3, isReel: true),
    );
  }
}