          ...
          content: SizedBox(
            ...
            child: Column(
              children: [
                Row(
                  children: const[
                    TextCustom(text: LanguageJameet.project_first, color: Colors.amber, fontWeight: FontWeight.w500 ),
                ...
                InkWell(
                  ...
                  child: Container(
                    ...
                    child: const TextCustom(text: LanguageJameet.ok, fontSize: 17, color: Colors.black87 ),
                  ),
                )
              ],
            ),
